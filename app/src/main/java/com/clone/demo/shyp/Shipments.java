...
public class Shipments {
    ...
    private ArrayList<ShipmentsResponseData> responseData;


    public Shipments(int user_id, String recipient_name
    ...
    public ArrayList<ShipmentsResponseData> getShipmentsResponseData() {
        return responseData;
    }

    public void setShipmentsResponseData(ArrayList<ShipmentsResponseData> shipmentsResponseData) {
