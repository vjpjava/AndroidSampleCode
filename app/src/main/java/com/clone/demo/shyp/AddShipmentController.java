...
public class AddShipmentController extends FragmentActivity implements ActionBar.TabListener {
    ...
    // END_INCLUDE (fragment_pager_adapter)
        ...
        public Fragment getItem(int position) {
            ...
            */
            ...
            // Set fragment to action bar tabs

            Fragment fragment;

            if(position == 0 ) { fragment = new AddNewShipmentFragment(); }
            else { fragment = new ShipmentAddressListFragment(); }
    ...
    public static class DummySectionFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_ship_address_list, container, false);
